...
! function(a, b) {
    ...
    function D(a, b, c) {
        if (b.enablePagination) {
            var d = a.find(".actions button[id='btn-submit-finish']").parent(),
    ...
    function L(a, b, c) {
        if (b.enablePagination) {
            ...
            if (b.enableFinishButton) {
                f += '<li><button type="submit" class="btn btn-sm btn-primary" id="btn-submit-finish" style="font-size:13px !important;" role="menuitem">{0}</button></li>'.format(b.labels.finish);
            }

            if (b.enableCancelButton) {
