@php
    ...
    $kelompokAsesor = App\Models\KelompokAsesor::where('kelas_id', $kelas_id)
        ...
        if(request()->routeIs('persetujuanAssesmen.*') || request()->routeIs('frapl.*') || request()->routeIs('frapl01.*') || request()->routeIs('frapl02.*')) {
...
<li @class(['menu','active' => request()->routeIs('event-asesi.*') || request()->routeIs('persetujuanAssesmen.*') || request()->routeIs('frapl.*') || request()->routeIs('frapl01.*') || request()->routeIs('frapl02.*')])>
    <a href="#kategori-ujian" data-toggle="collapse" aria-expanded="{{ request()->routeIs('event-asesi.*') || request()->routeIs('persetujuanAssesmen.*') || request()->routeIs('frapl.*') || request()->routeIs('frapl01.*') || request()->routeIs('frapl02.*') ? 'true' : 'false' }}" class="dropdown-toggle">
        <div class="">
    ...
    <ul @class(['collapse','submenu','list-unstyled','show' => request()->routeIs('event-asesi.*') || request()->routeIs('persetujuanAssesmen.*') || request()->routeIs('frapl.*') || request()->routeIs('frapl01.*') || request()->routeIs('frapl02.*')]) id="kategori-ujian" data-parent="#accordionExample">
