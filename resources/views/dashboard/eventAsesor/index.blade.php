...
@section('content')
                    ...
                    <li class="breadcrumb-item dropdown">
                        ...
                        <div class="dropdown-menu right" aria-labelledby="pendingTask" style="will-change: transform; position: absolute; transform: translate3d(105px, 0, 0px); top: 0px; left: 0px;">
                            @forelse($kelompokAsesor as $data)
                                <a class="dropdown-item" href="{{ route('event-asesor.show', $data['uuid']) }}">{{ $data->event['nama_event'] }}</a>
                            @empty
        ...
        <div class="col-lg-12">
            <div class="statbox widget box box-shadow">
                <div class="widget-content widget-content-area">
                    <table id="table-event-saya" class="table style-3 table-hover" data-route="{{ route('event-asesor.datatable', request()->segment(2)) }}">
                        <thead>
                            <tr>
    ...
    @push('datatable')
        @include('dashboard.eventAsesor.component')
        @include('dashboard.eventAsesor.datatable')
    @endpush
@endsection
