...
@section('content')
    <div class="row layout-top-spacing" id="cancel-row">
        ...
        <div class="col-lg-12">
            <div class="d-flex justify-content-end">
                <button type="button" class="btn btn-primary mb-2 mr-2" data-toggle="modal" data-target="#modal-event" onclick="modalFormCreate(this)">
    ...
    @push('datatable')
        @include('dashboard.event.component')
        @include('dashboard.event.datatable')
        @include('dashboard.event.modalListSkema')
        @include('dashboard.event.edit')
    @endpush
@endsection
