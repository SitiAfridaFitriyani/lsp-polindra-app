<div class="modal fade" id="modal-event" data-key-modal="modal-event" tabindex="-1" role="dialog" aria-labelledby="exampleModalCenterTitle" aria-hidden="true">
    <div class="modal-dialog modal-dialog-centered modal-lg" role="document">
        <div class="modal-content">
            <div class="modal-header">
                <h5 class="modal-title" id="exampleModalCenterTitle">Tambah Data Event</h5>
                        ...
                        <form class="needs-validation" novalidate method="POST" action="{{ route('event.store') }}">
                            ...
                            <div class="form-row">
                                ...
                                <div class="col-md-6 mb-4">
                                    ...
                                    <select class="form-control select-tuk @error('tuk') is-invalid @enderror" name="tuk" required>
