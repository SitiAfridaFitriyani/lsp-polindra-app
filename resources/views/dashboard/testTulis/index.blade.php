...
@section('title','Kelola Ujian Tulis')
@section('content')
                ...
                <ol class="breadcrumb">
                    ...
                    <li class="breadcrumb-item dropdown">
                        ...
                        <div class="dropdown-menu right" aria-labelledby="pendingTask" style="will-change: transform; position: absolute; transform: translate3d(105px, 0, 0px); top: 0px; left: 0px;">
                            <a class="dropdown-item" href="{{ route('ujianPraktek.index') }}">Test Praktek</a>
                        </div>
                    </li>
                    <li class="breadcrumb-item active" aria-current="page">Test Tulis</li>
                </ol>
            </nav>
        </div>
        <div class="col-lg-12">
            <div class="d-flex justify-content-end">
                <button type="button" class="btn btn-primary mb-2 mr-2" data-toggle="modal" data-target="#modal-testTulis" onclick="modalFormCreate(this)">
            ...
            @include('dashboard.testTulis.create')
            <div class="statbox widget box box-shadow">
                <div class="widget-content widget-content-area">
                    <table id="table-testTulis" class="table style-3 table-hover" data-route="{{ route('ujianTulis.datatable') }}">
                        <thead>
                            <tr>
                                <th>Pertanyaan</th>
                                <th>Kunci Jawaban</th>
