...
<div class="row layout-top-spacing" id="cancel-row">
    ...
    <div class="col-lg-12">
        <div class="d-flex justify-content-end">
            <button type="button" class="btn btn-primary mb-2 mr-2" data-toggle="modal" data-target="#modal-jurusan" onclick="modalFormCreate(this)">
        ...
        <div class="statbox widget box box-shadow">
            <div class="widget-content widget-content-area">
                <table id="table-jurusan" class="table style-3 table-hover" data-route="{{ route('jurusan.datatable') }}">
                    <thead>
                        <tr>
                            <th>Nama Jurusan</th>
                            <th>Deskripsi</th>
                ...
                @include('dashboard.jurusan.modalKelas')
            </div>
        </div>
    </div>
</div>
@push('datatable')
        @include('dashboard.jurusan.component')
        @include('dashboard.jurusan.datatable')
        @include('dashboard.jurusan.listKelas')
        @include('dashboard.jurusan.edit')
    @endpush
@endsection
