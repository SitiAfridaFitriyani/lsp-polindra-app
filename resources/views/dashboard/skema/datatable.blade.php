    ...
    function getData() {
        ...
        $.ajax({
            ...
            success: function(response) {
                ...
                const listUnitKompetensiRoute = '{{ route("skema.list-unitKompetensi", [":uuid"]) }}';
                let skemaName = '';
                                    ...
                                    render: function(data) {
                                        ...
                                        return `
                                            <ul class="table-controls">
                                                ...
                                                <li>
                                                    <a href="javascript:void(0);" class="bs-tooltip" data-toggle="tooltip" data-placement="top" title="" data-original-title="Edit Skema">
                                                ...
                                                <li>
                                                    <a href="javascript:void(0);" class="bs-tooltip" onclick="handleDelete(this)" data-route="${deleteRouteRendered}" data-toggle="tooltip" data-placement="top" title="" data-original-title="Delete Skema">
