    ...
    function getData() {
        ...
        $.ajax({
            ...
            success: function(response) {
                ...
                const listUnitKompetensiRoute = '{{ route("unitKompetensi.listByUuid", [":uuid"]) }}';
                                ...
                                return `
                                    <ul class="table-controls">
                                        <li onclick="handleListUnitKompetensi(this)" data-modal="modal-list-unitKompetensi" data-route="${listUnitKompetensiRouteRendered}" data-skemaName="${skemaName}">
                                            <a href="javascript:void(0);" class="bs-tooltip" data-toggle="tooltip" data-placement="top" title="List Unit Kompetensi">
