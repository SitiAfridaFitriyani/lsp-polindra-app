<div class="modal fade" id="modal-skema" data-key-modal="modal-skema" tabindex="-1" role="dialog" aria-labelledby="exampleModalCenterTitle" aria-hidden="true">
    <div class="modal-dialog modal-dialog-centered modal-lg" role="document">
        <div class="modal-content">
            <div class="modal-header">
                <h5 class="modal-title" id="exampleModalCenterTitle">Tambah Data Skema</h5>
            ...
            <div class="modal-body">
                ...
                <p class="modal-text">
                    <div class="widget-content widget-content-area">
                        <form class="needs-validation" novalidate method="POST" action="{{ route('skema.store') }}">
                            @csrf
                            <div class="form-row">
                            ...
                            <div class="form-row">
                                ...
                                <div class="col-md-6 mb-4">
                                    ...
                                    <select class="form-control select-event @error('tuk') is-invalid @enderror" name="tuk" required>
