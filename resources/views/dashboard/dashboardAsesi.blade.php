...
@if(Auth::user()->asesi['status'] === 'nonactive')
    <div class="modal fade modal-notification" id="staticBackdrop" data-backdrop="static" data-keyboard="false" tabindex="-1" role="dialog" aria-labelledby="standardModalLabel" aria-hidden="true">
        <div class="modal-dialog" role="document" id="standardModalLabel">
            ...
            <div class="modal-body text-center">
                ...
                <p class="modal-text">
                    Oopss... Akun assesmenmu belum terverifikasi, harap hubungi admin untuk dapat melanjutkan assesmen
                </p>
                </div>
            </div>
        </div>
