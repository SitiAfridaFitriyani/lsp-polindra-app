    ...
    function getData() {
        ...
        $.ajax({
            ...
            success: function(response) {
                ...
                const deleteRoute = '{{ route("kelas.destroy", [":uuid"]) }}';
                const listAsesorRoute = '{{ route("asesor.listByUuid", [":uuid"]) }}';
                const editRoute = '{{ route("kelas.edit", [":uuid"]) }}';
                ...
                table.DataTable({
                    ...
                    "columns": [
                        ...
                        },
                        {
                            data: 'jurusan',
                            render: function(data) {
                                return data ? data.nama_jurusan : 'N/A';
                            }
                        },
                        {
                            data: 'keterangan'
                                ...
                                return `
                                    <ul class="table-controls">
                                        <li onclick="handleListAsesor(this)" data-modal="modal-list-asesor" data-route="${listAsesorRouteRendered}" data-kelasName="${kelasName}">
                                            <a href="javascript:void(0);" class="bs-tooltip" data-toggle="tooltip" data-placement="top" title="List Asesor Unjuk Kerja">
                                        ...
                                        <li onclick="handleEdit(this)" data-route="${editRouteRendered}" data-uuid="${data}">
                                            <a href="javascript:void(0);" class="bs-tooltip" data-toggle="tooltip" data-placement="top" title="Edit Kelas">
                                        ...
                                        <li onclick="handleDelete(this)" data-route="${deleteRouteRendered}">
                                            <a href="javascript:void(0);" class="bs-tooltip" data-toggle="tooltip" data-placement="top" title="Delete Kelas">
