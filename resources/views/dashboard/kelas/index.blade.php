    ...
    <div class="row layout-top-spacing" id="cancel-row">
        ...
        <div class="col-lg-12">
            <div class="d-flex justify-content-end">
                <button type="button" class="btn btn-primary mb-2 mr-2" data-toggle="modal" data-target="#modal-kelas" onclick="modalFormCreate(this)">
            ...
            <div class="statbox widget box box-shadow">
                <div class="widget-content widget-content-area">
                    <table id="table-kelas" class="table style-3 table-hover" data-route="{{ route('kelas.datatable') }}">
                        <thead>
                            <tr>
                                <th>Nama kelas</th>
                                <th>Jurusan</th>
                    ...
                    @include('dashboard.kelas.modalAsesor')
                </div>
            </div>
        </div>
    </div>
    @push('datatable')
        @include('dashboard.kelas.component')
        @include('dashboard.kelas.datatable')
        @include('dashboard.kelas.listAsesor')
        @include('dashboard.kelas.edit')
    @endpush
@endsection
