    ...
    <div class="row layout-top-spacing" id="cancel-row">
        ...
        <div class="col-lg-12">
            <div class="d-flex justify-content-end">
                <button type="button" class="btn btn-primary mb-2 mr-2" data-toggle="modal" data-target="#modal-elemen" onclick="modalFormCreate(this)">
            ...
            @include('dashboard.elemen.create')
            <div class="statbox widget box box-shadow">
                <div class="widget-content widget-content-area">
                    <table id="table-elemen" class="table style-3 table-hover" data-route="{{ route('elemen.datatable') }}">
                        <thead>
                            <tr>
                                <th>Nama Elemen</th>
                    ...
                    @include('dashboard.elemen.modalKriteriaUnjukKerja')
                </div>
            </div>
        </div>
    </div>
    @push('datatable')
        @include('dashboard.elemen.component')
        @include('dashboard.elemen.datatable')
        @include('dashboard.elemen.listKriteriaUnjukKerja')
        @include('dashboard.elemen.edit')
    @endpush
@endsection
